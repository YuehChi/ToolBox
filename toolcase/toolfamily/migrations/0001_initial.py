# Generated by Django 3.1 on 2022-03-23 12:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ended_datetime', models.DateTimeField(default=datetime.datetime(2022, 3, 30, 12, 19, 32, 818374, tzinfo=utc), verbose_name='結束時間')),
                ('lastChange', models.DateTimeField(auto_now=True, verbose_name='最後修改時間')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='其他', help_text='0:關閉，1:徵求，2:進行，3:完成', max_length=10, verbose_name='狀態名稱')),
            ],
            options={
                'verbose_name': '委託狀態',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, default='', help_text='主頁上對他人是顯示這個', max_length=10, verbose_name='暱稱')),
                ('gender', models.CharField(blank=True, default='', max_length=5, verbose_name='生理性別')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='其他', max_length=10, verbose_name='類型名稱')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='建立時間')),
                ('status', models.BooleanField(default=False, help_text='0:未處理，1:已處理', verbose_name='是否已處理')),
                ('confirmed', models.BooleanField(blank=True, default=False, help_text='0:不成立（無效的檢舉），1:成立（有效的檢舉）', null=True, verbose_name='檢舉是否成立')),
        ...
        migrations.CreateModel(
            name='FollowUser',
            fields=[
                ('followuser_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='FollowCase',
            fields=[
                ('followcase_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='其他', max_length=10, verbose_name='領域名稱')),
        ...
        migrations.AddField(
            model_name='case',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cases', to='toolfamily.userdetail', verbose_name='委託人'),
        ),
        migrations.AddField(
            model_name='case',
            name='status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('commissionrecord_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('rate_toolman', models.SmallIntegerField(blank=True, default=None, help_text='委託人給工具人打分', null=True, verbose_name='工具人評價')),
                ('rate_case_cCreator', models.SmallIntegerField(blank=True, default=None, help_text='工具人給委託人打分', null=True, verbose_name='委託人評價')),
                ...
                ('status', models.ForeignKey(help_text='使用者_維修單狀態，若是工具人身分，則此欄位用於判斷使用者在維修單上的按鈕狀態，及該維修單在使用者個人頁面狀態', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commission_record', to='toolfamily.status', verbose_name='狀態')),
            ],
            options={
                'verbose_name': '承接紀錄',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('casewillingness_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('information', models.TextField(blank=True, default='', verbose_name='附加資訊')),
                ('created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='應徵時間')),
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applyed_by', to='toolfamily.case', verbose_name='委託單')),
        ...
        migrations.CreateModel(
            name='CasePhoto',
            fields=[
                ('casephoto_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
